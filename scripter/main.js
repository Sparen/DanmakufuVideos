...
function parse() {
    ...
    tableofcontents += '<a class="btn btn-primary btn-sm" role="button" data-toggle="collapse" href="#toccontents" aria-expanded="true" aria-controls="toccontents">Toggle Table of Contents</a>';
